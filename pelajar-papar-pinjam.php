...
<div class="container">
	...
	<div class="row">
		...
		<div class="col-xs-8">
            <?php  echo "<a href='pelajar-tambah-pinjam.php' class='btn btn-primary m-b-1em'>Tambah Pinjaman</a>";  ?>                         
...
{         
 ...
 <tr>
     ...
     <td><a href="pelajar-edit-pinjam.php?stdid=<?php echo htmlentities($result->id);?>" class="btn btn-primary" >Papar</a></td>
</tr>
<?php $cnt++;} }?>
</tbody>
</table>
